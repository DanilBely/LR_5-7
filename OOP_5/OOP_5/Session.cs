...
namespace OOP_5
{
    public class Session//Контейнерные классы - это универсальные шаблонные классы, предназначенные для хранения элементов заданного типа в смежных областях памяти.
    {
